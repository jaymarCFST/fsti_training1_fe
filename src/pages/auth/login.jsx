...
const Login = () => {
    ...
    async function login() 
    {
        ...
        const auth = await APIServices.login(data).catch(
            async (error) => {
                console.log(error);
            }
        ).then(
    ...
    <div className="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
            <div className="flex justify-center items-center">
                <span className="text-5xl font-medium text-center text-blue-500">FSTI Training 1</span>
            </div>
        ...
        <div className="bg-blue-300 py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div>
                ...
                <input
                    ...
                    onChange={(e) => handleLoginUsernameInput(e.target.value)} 
                    id="username"
                    name="username"
                    type="text"
            ...
            <div>
                ...
                <input
                    ...
                    onChange={(e) => handleLoginPasswordInput(e.target.value)}
                    id="password"
                    name="password"
                    type="password"
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="text-sm space-x-2">
                    ...
                    <span onClick={onClickRegister} className="font-medium cursor-pointer text-[#213766] hover:text-indigo-500">
                        Register now
                    </span>
                </div>
            </div>
